...
function moduleProject2() {
  ...
  document.addEventListener('keydown', evt => {
    ...
    let mosquitosalive = document.querySelectorAll('[data-status = alive]')
    if(!mosquitosalive.length){
      ...
      document.querySelector('h2').insertAdjacentElement('beforeend', resetgame)
    }
  })
